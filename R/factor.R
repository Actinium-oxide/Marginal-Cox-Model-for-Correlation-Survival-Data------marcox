...
#'
#' In general, it is not necessary for a binary covariate column to be converted to a dummy variable by \code{factor()}. This can lead to unknown errors.
#' @example
#' #This example cannot run before the initialization of the data.

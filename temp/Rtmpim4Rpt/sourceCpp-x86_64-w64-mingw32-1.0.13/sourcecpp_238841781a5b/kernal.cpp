...
//[[Rcpp::export]]
MatrixXd kernal_1(VectorXd dd_c, VectorXd g11_c, VectorXd t11_c, VectorXd tt1_c,
  ...
  while (true){
    ...
    while(true){
      ...
      float rho=(pphi*(-1))*rres/(n_c.array()*(n_c-temp_2).array()).sum()/2-X1.cols();
      int SK=1;
      while(true){
        VectorXd mu_temp;
...
// kernal_1
MatrixXd kernal_1(VectorXd dd_c, VectorXd g11_c, VectorXd t11_c, VectorXd tt1_c, VectorXd t2_c, VectorXd betainit_c, MatrixXd x111_c, MatrixXd xxx_c, VectorXd c1_c, VectorXd n_c, VectorXd id_c, VectorXd Kn_ls_c, int kk_c, int Kn_c, int K_c);

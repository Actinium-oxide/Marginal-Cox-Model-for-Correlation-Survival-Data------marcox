...
// marcox_iter_Cpp_eai
List marcox_iter_Cpp_eai(const Eigen::Map<Eigen::MatrixXd>& X1, Eigen::Map<Eigen::VectorXd> betainit, Eigen::Map<Eigen::VectorXd> Lambda, const NumericVector& c1, const NumericMatrix& W1, const NumericVector& id, const IntegerVector& new_uid, const IntegerVector& n, const float& tol, double pphi, double rho, Eigen::Map<Eigen::VectorXd> rho_vec_k, const int& kv, Eigen::Map<Eigen::MatrixXd> rhomat, const short& method, int SK1, const bool& diag);
RcppExport SEXP _marcox_marcox_iter_Cpp_eai(SEXP X1SEXP, SEXP betainitSEXP, SEXP LambdaSEXP, SEXP c1SEXP, SEXP W1SEXP, SEXP idSEXP, SEXP new_uidSEXP, SEXP nSEXP, SEXP tolSEXP, SEXP pphiSEXP, SEXP rhoSEXP, SEXP rho_vec_kSEXP, SEXP kvSEXP, SEXP rhomatSEXP, SEXP methodSEXP, SEXP SK1SEXP, SEXP diagSEXP) {
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< int >::type SK1(SK1SEXP);
    Rcpp::traits::input_parameter< const bool& >::type diag(diagSEXP);
    rcpp_result_gen = Rcpp::wrap(marcox_iter_Cpp_eai(X1, betainit, Lambda, c1, W1, id, new_uid, n, tol, pphi, rho, rho_vec_k, kv, rhomat, method, SK1, diag));
...
static const R_CallMethodDef CallEntries[] = {
    {"_marcox_marcox_iter_Cpp_eai", (DL_FUNC) &_marcox_marcox_iter_Cpp_eai, 17},
